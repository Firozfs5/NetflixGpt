...
const SmpUp = ({ movieData, trailerId }) => {
      ...
      <div className="mt-20 w-full h-12 px-[2.6%] py-2 flex justify-between ">
        ...
        <div className="flex text-4xl justify-between items-center w-[15.3%]">
          <div className="flex justify-center items-center">
            <span
              onClick={() => setFav(!fav)}
              className="text-white text-xl flex items-center justify-center  rounded-xl bg-gray-900 hover:bg-gray-800/80 px-5 py-2.5 font-medium"
            >
          ...
          <button
            ...
            className="relative inline-flex items-center justify-center rounded-xl bg-gray-900 hover:bg-gray-800/80 p-2.5 text-white outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 transition"
            title="Share"
          >
      ...
      <div className=" h-[510px] w-[95%] relative  ">
        ...
        <div className="absolute inset-0 h-[510px] flex justify-center items-center gap-6">
          ...
          <div className="w-[18%] h-[90%] bg-gray-600/50 rounded-2xl flex gap-4 flex-col justify-center items-center">
            <div className="w-[80%] h-[40%] bg-black/20 hover:bg-black/10 rounded-2xl flex justify-center items-center text-white text-5xl">
              <CgPlayList />
            </div>
            <div className="w-[80%] h-[40%] bg-black/20 hover:bg-black/10 rounded-2xl flex justify-center items-center text-white text-5xl">
              <IoMdPhotos />
