  ...
  return (
    <div>
      ...
      <form
        ...
        className="w-md my-36 absolute px-12 py-10 bg-black/85 mx-auto right-0 left-0 text-white  rounded-xl"
      >
        ...
        <button
          ...
          className="bg-[#e50914] w-full py-3 px-2 my-4 rounded-lg font-medium active:bg-red-800"
        >
          {isSignIn ? "Sign In" : "Sign Up"}
        </button>
        ...
        <span
          className="text-lg mt-2 cursor-pointer font-medium hover:border-b-2"
